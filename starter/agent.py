...
Responsibilities are split across the catalog, intent, retrieval, ranking, and
dialogue modules; this class only orchestrates them into the Agent API contract.
"""
